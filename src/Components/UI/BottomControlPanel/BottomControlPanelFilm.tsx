...
export const BottomControlPanelFilm = () => {
  ...
  return (<>
    {stageState.enableFilm !== '' && <>
      ...
      {showPanel.value && <div className={styles.container}>
        ...
        <span id="Button_ControlPanel_auto" className={styles.singleButton} onClick={()=>{switchAuto();showPanel.set(!showPanel.value);}}>
          <span className={styles.button_text}>自动模式 / AUTO</span>
        </span>
        <span id="Button_ControlPanel_fast" className={styles.singleButton} onClick={()=>{switchFast();showPanel.set(!showPanel.value);}}>
