...
function removeFig(figObj: IStageObject, enterTickerKey: string, effects: IEffect[]) {
  ...
  WebGAL.gameplay.pixiStage!.registerPresetAnimation(animation, leaveKey, figKey, effects, stopFunction);
}
